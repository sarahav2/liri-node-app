...
function myTweets() {
    var client = new twitter({
        consumer_key: 'CuuVrKqGG6fiZBMPdVBS31LPl',
        consumer_secret: 'v5cW3tl6nKYxBnwDwCFRPUrvOfWfVpTRuBwDugbV6UItoWBgVj',
        access_token_key: '604423341-3uMMBQNh7urfhNp9sGXl4lt6rjVR4JL6adfhrTss',
        access_token_secret: '0hIJPinJeOvwjPTJ9YaQDbz0y03UUinaRndYF798j8TfB',
        
    });
    var twitterUsername = process.argv[3];
    if(!twitterUsername){
        twitterUsername = "saywah_says";
    }
